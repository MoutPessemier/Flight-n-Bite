...
namespace Flight__n_Bite.ViewModels
{
    public class WeatherViewModel
    {
        ...
        private async void LoadWeather()
        {
            ...
            string url = "http://api.meteomatics.com/nowP10D:P1D/t_2m:C/" + Flight.EndLatitude.ToString() + "," + Flight.EndLatitude.ToString() + "/json";
            //string json = await httpService.GetWeatherAsync(new Uri(url));
            ...
            RootObject obj = JsonConvert.DeserializeObject<RootObject>(jsonFake);
